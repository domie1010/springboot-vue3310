...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateHuodongjilu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改活动记录<input type="hidden" name="id" value="${huodongjilu.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xuehao.value='${huodongjilu.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${huodongjilu.xingming}';</script>	<script language="javascript">document.form1.riqi.value='${huodongjilu.riqi}';</script>	<script language="javascript">document.form1.jiaowangduixiang.value='${huodongjilu.jiaowangduixiang}';</script>	<script language="javascript">document.form1.huodonghuafei.value='${huodongjilu.huodonghuafei}';</script>	<script language="javascript">document.form1.huodongneirong.value='${huodongjilu.huodongneirong}';</script>	
					 </table>
			</form>
   </body>
</html>
