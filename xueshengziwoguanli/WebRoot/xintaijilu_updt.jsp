...
function gows()
{
	document.location.href="xintaijilu_add.jsp?id=<%=id%>";
}
	...
	<body>
			<form action="updateXintaijilu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.xuehao.value='${xintaijilu.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${xintaijilu.xingming}';</script>	<script language="javascript">document.form1.riqi.value='${xintaijilu.riqi}';</script>	<script language="javascript">document.form1.zhuangtai.value='${xintaijilu.zhuangtai}';</script>	<script language="javascript">document.form1.fuqingxuyuan.value='${xintaijilu.fuqingxuyuan}';</script>	<script language="javascript">document.form1.chulifangshi.value='${xintaijilu.chulifangshi}';</script>	<script language="javascript">document.form1.shifouyouxiao.value='${xintaijilu.shifouyouxiao}';</script>	<script language="javascript">document.form1.beizhu.value='${xintaijilu.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
