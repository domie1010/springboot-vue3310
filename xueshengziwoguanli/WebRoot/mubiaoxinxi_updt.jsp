...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateMubiaoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改目标信息<input type="hidden" name="id" value="${mubiaoxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xuehao.value='${mubiaoxinxi.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${mubiaoxinxi.xingming}';</script>	<script language="javascript">document.form1.mubiao.value='${mubiaoxinxi.mubiao}';</script>	<script language="javascript">document.form1.xiangqingmiaoshu.value='${mubiaoxinxi.xiangqingmiaoshu}';</script>	<script language="javascript">document.form1.qiwangriqi.value='${mubiaoxinxi.qiwangriqi}';</script>	<script language="javascript">document.form1.dangqianjindu.value='${mubiaoxinxi.dangqianjindu}';</script>	<script language="javascript">document.form1.jindumingxi.value='${mubiaoxinxi.jindumingxi}';</script>	
					 </table>
			</form>
   </body>
</html>
